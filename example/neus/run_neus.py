...
from accelRF.pointsampler.neus_pointsampler import NeusPointSampler
from accelRF.models import PositionalEncoding
from accelRF.models.volsdf import AbsDensity, SDFNet, RGBNet, NeuSDensity
from accelRF.render.neus_render import NeuSRender
...
def main():
    ...
    volsdf_render = NeuSRender(
        ...
        density_fn=NeuSDensity(args.init_val),
        # NeRF++ background
    ...
    for i in trange(start, args.N_iters):
        ...
        render_out = volsdf_render_(rays_o, rays_d, i)
